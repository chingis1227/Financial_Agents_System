# market_sense.md - Gold market sense
...
- Required follow-up: Build a driver battle matrix using aligned gold, real-rate, USD, Fed-pricing, ETF-flow, CFTC, and risk-stress data.

## Module summary

The market-sense module prevents overclaiming causality: it maps hypotheses and required confirmations rather than declaring the cause of every move.

## Smoke-test findings

The key driver battle is real-rate pressure versus hedge/reserve demand, with USD strength and positioning flows as major confirming or opposing signals.

# portfolio_fit.md - Gold portfolio fit
...
- Required follow-up: Collect user portfolio context and vehicle preference before any personalized sizing discussion.

## Module summary

The portfolio module confirms the output must remain a Decision-Prep Memo because portfolio context is missing.

## Smoke-test findings

Gold can be a non-income diversifier and hedge sleeve, but effectiveness is regime-dependent and exact sizing is blocked without portfolio context.

# news_catalysts.md - Gold news and catalysts
...
- Required follow-up: Refresh event evidence immediately before IC synthesis.

## Module summary

The news module separates confirmed catalysts from reported or lagged data and prevents rumor-like inputs from becoming final evidence.

## Smoke-test findings

Material catalysts are Fed/real-rate repricing, USD, inflation prints, ETF-flow confirmation, official-sector reserve data, and geopolitical stress or de-escalation.

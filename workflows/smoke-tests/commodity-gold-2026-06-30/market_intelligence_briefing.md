# market_intelligence_briefing.md - Gold market intelligence briefing
...
- Required follow-up: Refresh all flow, positioning, price, macro, and vehicle data after the 2026-06-30 close before IC use.

## Module summary

The market-intelligence module gives the IC a situational map and routing notes, not an investment action.

## Smoke-test findings

Market intelligence frames gold as correcting from highs while still supported by reserve diversification; near-term pressure depends on real rates, USD, and flow confirmation.

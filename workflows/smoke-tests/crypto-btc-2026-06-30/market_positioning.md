# market_positioning.md - BTC crypto smoke-test artifact
...
- Required follow-up: Refresh ETF flows after 2026-06-30 close and add cross-exchange validation.
...
Weak ETF/sentiment read, mild long leverage, defensive options skew, and mixed crowding.

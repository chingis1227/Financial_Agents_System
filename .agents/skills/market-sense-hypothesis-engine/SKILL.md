...
- In a large workflow, this skill produces a market-move hypothesis handoff only: observed move, plausible drivers, confidence, cross-asset checks, alternatives, and module status.
...
Requires evidence-backed confidence; separate dominant, supporting, opposing, and unsupported drivers; SENSE: maps here.

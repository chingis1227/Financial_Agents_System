...
- In a large workflow, this skill produces a discovery / candidate-context handoff only when discovery context is relevant to the asset decision.
...
Discovery-only: output candidate watchlist and review priority, not buy/sell/hold list.

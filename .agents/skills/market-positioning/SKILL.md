...
- In a large workflow, this skill produces a positioning / expectations-bar handoff only: crowding, flows, narrative saturation, positioning risk, evidence limits, and module status.
- It must not claim positioning alone determines fundamental value or issue final buy/sell/hold language.
- If positioning evidence is indirect or incomplete, mark the module `Limited` and explain the limitation.

...
- In a large workflow, this skill produces a driver-dominance handoff only: observed move, candidate drivers, confidence, disconfirming evidence, evidence/freshness limits, and module status.
...
Requires evidence-backed confidence and explicit dominant/supporting/opposing/unsupported driver split.

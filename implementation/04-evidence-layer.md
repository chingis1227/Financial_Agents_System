...
| Rule ID | Decision |
|---|---|
| P3-EVD-01-01 | When evidence is incomplete and the user asks for a final conclusion, Quick Take is allowed only when explicitly requested as `QUICK:` / short / fast / quick take / preliminary. Otherwise, concrete-asset investment action requests route to `AGENT:` / internal full workflow with Evidence Gap / Decision-Prep / Limited IC treatment as gates require; do not silently downgrade to Quick Take. |
